...
<head>
  ...
  <style>
    ...
    .review-text {
    margin-top: 6px;
    white-space: pre-wrap; /* tetap mempertahankan enter/line break */
    word-wrap: break-word; /* memaksa kata panjang untuk pindah baris */
    overflow-wrap: break-word; /* fallback untuk browser lain */
    max-width: 100%; /* jangan melewati container */
}
